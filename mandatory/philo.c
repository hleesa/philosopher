...
{
	print_state(philo, common_philo->base_usec + philo->error_usec, philo->nth_philo, THINK);
}
...
//	philo->svaed_usec = get_usec();
	print_state(philo, common_philo->base_usec + philo->error_usec, philo->nth_philo, FORK);
	print_state(philo,common_philo->base_usec + philo->error_usec, philo->nth_philo, FORK);

    print_state(philo,common_philo->base_usec + philo->error_usec, philo->nth_philo, EAT);
...
//    philo->error_usec += (get_usec() - philo->svaed_usec) % common_philo->time_to_eat;
}
void	sleep_philo(t_philo *philo, t_common_philo *common_philo)
{
//    philo->svaed_usec = get_usec();
	print_state(philo,common_philo->base_usec + philo->error_usec, philo->nth_philo, SLEEP);
	my_usleep(common_philo->time_to_sleep);
//    philo->error_usec += (get_usec() - philo->svaed_usec) % common_philo->time_to_sleep;
